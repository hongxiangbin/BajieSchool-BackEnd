...
public interface ActivityCommentCommentMapper {
    int deleteByPrimaryKey(@Param("aCCId") String aCCId, @Param("actComId") String actComId, @Param("username") String username);

    int insert(ActivityCommentComment record);

    int insertSelective(ActivityCommentComment record);

    ActivityCommentComment selectByPrimaryKey(@Param("aCCId") String aCCId, @Param("actComId") String actComId, @Param("username") String username);
